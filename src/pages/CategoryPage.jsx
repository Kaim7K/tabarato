...
export default function CategoryPage() {
  ...
  if (slug === "abaixo-de-50") {
    filtered = offers.filter((o) => o.price < 50);
  ...
  if (activeFilter === "clicked") {
    ...
    filtered = filtered.filter((o) => o.price < 50);
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium rounded-full whitespace-nowrap transition ${
                  activeFilter === f.key
                    ...
                    : "bg-white text-[#111111]/60 hover:bg-white/80 border border-[#111111]/8"
                }`}
              >
                {f.label}
              </button>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-[#111111]/40 text-lg">Nenhum achado nesta categoria ainda.</p>
          </div>
        ) : (
