...
const CATEGORIES = [
  { name: "Casa e organização", slug: "casa-e-organizacao" },
  { name: "Tecnologia", slug: "tecnologia" },
  { name: "Escritório", slug: "escritorio" },
  { name: "Ferramentas", slug: "ferramentas" },
  { name: "Cozinha", slug: "cozinha" },
  { name: "Beleza e cuidados", slug: "beleza-e-cuidados" },
  { name: "Abaixo de R$ 50", slug: "abaixo-de-50" },
  { name: "Abaixo de R$ 100", slug: "abaixo-de-100" },
];
    ...
    <header className="sticky top-0 z-50 bg-[#F5F2EB]/85 backdrop-blur-md border-b border-[#111111]/8">
        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            <div className="relative group">
              <button className="text-sm font-medium text-[#111111] hover:text-[#FF6B35] transition flex items-center gap-1">
                Categorias
              </button>
          ...
          <button onClick={() => setMobileOpen(!mobileOpen)} className="lg:hidden p-2 text-[#111111]">
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-[#111111]/8 bg-[#F5F2EB] px-4 py-4 space-y-4">
          ...
          <Link to="/favoritos" onClick={() => setMobileOpen(false)} className="block text-center px-5 py-3 bg-white text-[#111111] text-sm font-semibold rounded-full flex items-center justify-center gap-2">
